...
function getSelectedConnector(...initializedConnectors) {
    ...
    function useSelectedWeb3React(connector, provider) {
        const index = getIndex(connector);
...
function getPriorityConnector(...initializedConnectors) {
    const { useSelectedChainId, useSelectedAccounts, useSelectedIsActivating, useSelectedError, useSelectedAccount, useSelectedIsActive, useSelectedProvider, useSelectedENSNames, useSelectedENSName, useSelectedWeb3React, } = getSelectedConnector(...initializedConnectors);
